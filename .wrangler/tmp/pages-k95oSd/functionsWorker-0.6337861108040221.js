...
var onRequestDelete = /* @__PURE__ */ __name(async ({ params, env: env2 }) => {
  try {
    ...
    await env2.DB.prepare("DELETE FROM transactions WHERE id = ? OR id = ?").bind(idParam, isNaN(idNum) ? idParam : idNum).run();
...
var TELEGRAM_CHAT_ID = "-1003201809285";
var TELEGRAM_THREAD_ID = "7637";
var CRC32_TABLE = (() => {
...
var TELEGRAM_CHAT_ID2 = "-1003201809285";
var TELEGRAM_THREAD_ID2 = "7637";
var onRequestPost4 = /* @__PURE__ */ __name(async ({ request }) => {
  try {
    ...
    tgForm.append("message_thread_id", TELEGRAM_THREAD_ID2);
...
// ../.wrangler/tmp/pages-k95oSd/functionsRoutes-0.051695281305656926.mjs
var routes = [
  {
